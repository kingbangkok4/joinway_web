...
<body>
 <h3 style="text-color:#000;text-align:center;">Map </h3>
<div id="contain_map">
...
<table width="550" border="0" cellspacing="0" cellpadding="0" style= "background-color:#000" >
  <tr>
    <td align="center">
<!--จาก : -->
<input type="hidden"  name="namePlace" type="text" id="namePlace" size="20" value="<?php echo $_REQUEST['poinFrom']; ?>" />
<!-- ถึง: -->
<input  type="hidden" name="toPlace" type="text" id="toPlace" size="20" value="<?php echo $_REQUEST['poinTo']; ?>"  />
