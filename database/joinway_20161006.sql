...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2016 at 10:01 PM
...
(1, '0001', '0002', 'ขับรถได้เหี้ยมาก', '0', '2016-08-05 00:00:00'),
(2, '0001', '0002', 'ขับรถได้เหี้ยมาก', '999', '2016-08-03 00:00:00'),
(3, '0002', '0001', 'พ่อมึงตายไอสัส', '15', '2016-08-04 00:00:00'),
(4, '0003', '0001', 'พ่อมึงตายยยยไอสัส', '20', '2016-08-06 00:00:00'),
(5, '0002', '0001', 'ทำไมมึงไม่ขับรถดีๆวะห่ะ', '15', '2016-08-12 00:00:00'),
(6, '0002', '0001', 'lkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsja\r\nlkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsjalkdsflls;dfsjdfklsja', '15', '2016-08-06 00:00:00');
...
(12, 'fsfsf', 'sfsf', '2016-09-03 04:12:00', NULL, NULL, NULL, NULL, 'ทดสอบ', 'fsfs', 'NOCAR', '0002'),
(13, 'fsfsfadasdas', 'sfsf', '2016-09-03 04:12:00', NULL, NULL, NULL, NULL, 'ทดสอบ', 'fsfsasdasd', 'CAR', '0002'),
(14, 'fsfsfadasdasadsdad', 'sfsf', '2016-09-03 04:12:00', NULL, NULL, NULL, NULL, 'ทดสอบ', 'fsfsasdasd', 'CAR', '0002');
